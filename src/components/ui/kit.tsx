...
const STATUS_TONES: Record<string, string> = {
  ...
  pending: 'bg-amber-500/15 text-amber-800 dark:text-amber-300 border-transparent',
  maintenance: 'bg-amber-500/15 text-amber-800 dark:text-amber-300 border-transparent',
  suspended: 'bg-amber-500/15 text-amber-800 dark:text-amber-300 border-transparent',
